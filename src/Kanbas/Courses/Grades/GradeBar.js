...
function GradeBar() {
  return (
    <>
      ...
      <div className="row">
        <div className="col-6">
          <label className="form-label fw-semibold" for="studentNames">
            Student Names
          </label>
          <input
          ...
          <button className="btn btn-secondary mt-2">
            <i class="fa fa-filter me-1"></i>Apply Fliters
          </button>
        </div>
        <div className="col-6">
          <label className="form-label fw-semibold" for="assignmentNames">
            Assignment Names
          </label>
          <input
            className="form-control"
