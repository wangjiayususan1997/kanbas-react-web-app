...
//API = "https://kanbas-node-server-app-sl11.onrender.com/a5/todos"
const COURSES_URL =
  "https://kanbas-node-server-app-sl11.onrender.com/api/courses";
const ASSIGNMENTS_URL =
  "https://kanbas-node-server-app-sl11.onrender.com/api/assignments";
