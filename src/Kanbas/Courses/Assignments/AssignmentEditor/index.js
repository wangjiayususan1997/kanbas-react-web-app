        ...
        <div className="row mb-3">
          <div className="col-3">
            <h3 className="text-end mb-4">
              <label className="form-label me-4">Assign</label>
            </h3>
          </div>
          <div className="col">
            <div className="border border-secondary-subtle p-3 mb-0 w-50">
              <h6>
                <label className="form-label" for="assignTo">
                  {" "}
                  Assign To
                </label>
              </h6>
              ...
              />
              <h6>
                <label class="form-label mt-3" for="due">
                  Due
                </label>
              </h6>
              <input
                defaultValue={"Oct 01,2023,11:59 PM"}
                type="date"
                className="form-control"
                id="due"
              />
              <div className="row">
                <div className="col-6">
                  <h6>
                    <label className="form-label mt-3" for="avalable">
                      Available from
                    </label>
                  </h6>
                  <input
                    ...
                    className="form-control"
                    id="avalable"
                    name="Oct 01,2023,11:59 PM"
                  />
                </div>
                <div className="col-6">
                  <h6>
                    <label className="form-label mt-3" for="until">
                      Until
                    </label>
                  </h6>
                  <input
