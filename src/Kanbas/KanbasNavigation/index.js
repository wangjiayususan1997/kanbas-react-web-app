...
function KanbasNavigation() {
  ...
  const linkToIconMap = {
    ...
    History: (
      <AiOutlineClockCircle className="wd-icon" style={{ fontSize: "2.4em" }} />
    ),
    Studio: (
    ...
    Commons: (
      <PiUsersThreeFill className="wd-icon" style={{ fontSize: "2.4em" }} />
    ),
    Help: (
  ...
  return (
    ...
    >
      <div className="block">
        <img src="/images/logo.jpg" style={{ width: "90px" }} />
      </div>
